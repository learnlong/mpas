...
public class ReportCorrosion  extends StructReportBase{
	 ...
	 * @param areaCode
	 */
	public ReportCorrosion(Document document, ComModelSeries ms, String ssiCode, String ssiName, String areaCode,SMain sMain,ISyBo syBo) {
		super(document);
	...
	public Table getTableTitle() throws Exception{
		...
		if(isFirst==0){
			taTitle.addCell(setCell("2.2.2   应力腐蚀评级(非金属)", fontCnTitle,Element.ALIGN_LEFT, Element.ALIGN_CENTER, 8, 1,0, null));
		}
