...
public class ReportS5a extends StructReportBase{
	...
	public ReportS5a(Document document, ComModelSeries ms, String ssiCode, String ssiName, String areaCode, IS5Bo s5Bo, SMain sMain) {
		super(document);
		...
		public Table getTableTitle() throws Exception{
			...
			taTitle.addCell(setCell("2.2.3    偶然性损伤评级（金属）", fontCnTitle,Element.ALIGN_LEFT, Element.ALIGN_CENTER, 8, 1, 0, null));
