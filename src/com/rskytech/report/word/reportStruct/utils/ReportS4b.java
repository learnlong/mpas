...
public class ReportS4b extends StructReportBase{
	...
	public ReportS4b(Document document, ComModelSeries ms, 
			String ssiCode, String ssiName, String areaCode, IS4Bo s4Bo, SMain sMain,int isFirst) {
		super(document);
	...
	public Table getTableCenter() throws Exception{
		...
		if(listItemNames!=null){
			...
			tac.addCell(setCell("修正后的EDR", fontNow, Element.ALIGN_CENTER, Element.ALIGN_CENTER, 1, 2));
	...
	public Table getTableTitle() throws Exception{
		...
		taTitle.addCell(setCell("2.2.1    环境损伤评级（非金属）", fontCnTitle,Element.ALIGN_LEFT, Element.ALIGN_CENTER, 8, 1, 0, null));
