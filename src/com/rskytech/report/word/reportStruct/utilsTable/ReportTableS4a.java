...
public class ReportTableS4a extends StructReportBase{
	...
	public ReportTableS4a(Document document, ComModelSeries ms, String ssiCode, String ssiName, String areaCode, IS4Bo s4Bo, List<SStep> sStepList) {
		super(document);
	...
	public Table getTableTitle() throws Exception{
		...
		taTitle.addCell(setCell("表7   重要结构项目一般环境损伤评级表（金属）", fontCnNormal,Element.ALIGN_CENTER, Element.ALIGN_CENTER, 8, 1, 0, null));
