...
public class ReportTableSya  extends StructReportBase{
	 ...
	 * @param areaCode
	 */
	public ReportTableSya(Document document, ComModelSeries ms, String ssiCode, String ssiName, String areaCode, List<SStep> sStepList,ISyBo syBo) {
		super(document);
	...
	public Table getTableTitle() throws Exception{
		...
		taTitle.addCell(setCell("表8    重要结构项目应力腐蚀评级表（金属）", fontCnNormal,Element.ALIGN_CENTER, Element.ALIGN_CENTER, 8, 1, 0, null));
