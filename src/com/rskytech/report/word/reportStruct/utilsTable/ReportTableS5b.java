...
public class ReportTableS5b extends StructReportBase{
	...
	public ReportTableS5b(Document document, ComModelSeries ms, String ssiCode, String ssiName, String areaCode, IS5Bo s5Bo, List<SStep> sStepList) {
		super(document);
		...
		public Table getTableTitle() throws Exception{
			...
			taTitle.addCell(setCell("表9   重要结构项目偶然损伤评级表（非金属）", fontCnNormal,Element.ALIGN_CENTER, Element.ALIGN_CENTER, 8, 1, 0, null));
