 ...
 * @param   lang      0(English)|1(Chinese)  Default Language is 0(English).
 */
function setmonthx(inputObj,dateFormatStyle,beginDate,endDate,lang){
	if(null == inputObj){return null;}
...
Date.prototype.dateAdd = function(interval, number) {
	switch (interval) {
	  case "y":
		...
		break;
	  case "m":
		 var dd=new Date(this.getFullYear(), this.getMonth() + number, checkDate2(this.getFullYear(), this.getMonth() + number, this.getDate()));
		 return dd;
		break;
	  case "d":
...
function checkDate2(year, month, date){
