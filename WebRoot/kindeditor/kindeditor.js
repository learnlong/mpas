...
K.options = {
	...
	*/
	items : [
	    'cut', 'copy', 'paste','|','justifyleft', 'justifycenter', 'justifyright','justifyfull','|',
	    'indent', 'outdent','|','subscript','superscript','|','fontname', 'fontsize','forecolor', 'hilitecolor', 'bold',
		'italic', 'underline','|','strikethrough', 'lineheight', '|','image','table', 'hr'
	],
...
function _formatHtml(html, htmlTags, urlType, wellFormatted, indentChar) {
	urlType = urlType || 'domain';//默认改成带域名的
